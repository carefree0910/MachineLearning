...
class LSTM:
    ...
    def __getitem__(self, item):
        return getattr(self, "_{}".format(item), None)

    def fit(self, im, om, generator, n_time_step=None, random_scale=None, n_hidden=None, activation=None,
...
if __name__ == '__main__':
    ...
    _digit_len, _digit_base, _n_digit = 4, 10, 3
    lstm = LSTMForAddition(n_time_step=_digit_len, epoch=100, n_hidden=128, random_scale=2, verbose=1)
    lstm.fit(_n_digit, _digit_base, generator=AdditionGenerator)
    ee, ie = lstm["log"]["epoch_err"], lstm["log"]["iter_err"]
